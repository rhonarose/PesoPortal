...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$existingData) {
        ...
        try {
            ...
            // Redirect the user to employerReq.php after form submission
            header("Location: employerReq.php");
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="file" id="logoInput" name="logo" accept="image/*" onchange="previewImage()">
                            </td>
                            <td>
                                <label for="description">Description:</label><br>
                                <textarea id="descriptionInput" name="description" rows="4" cols="100" style="width: 420px;"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
